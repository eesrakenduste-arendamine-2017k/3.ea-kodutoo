...
// Production steps of ECMA-262, Edition 6, 22.1.2.1
    ...
    Array.from(document.getElementsByClassName('watch-title'))// get all code snippets
        .forEach(function (block) {
            ...
            block.addEventListener('click', function (event) {
                ...
                //Lets remove everything between brackets because song titles in youtube often contain things like "(official video)" etc.
                var stripedText = text.replace(/ *\([^)]*\) */g, "");
                //Discogs search
